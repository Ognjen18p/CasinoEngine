...
public class BlackJackStylization {
    ...
    private void styleLabels() {
        // "Place your bets" label styling
        Label placeYourBetsLabel = blackJack.getPlaceYourBetsLabel();
        placeYourBetsLabel.setStyle(
                "-fx-font-size: 28px;" +
                        "-fx-font-weight: bold;" +
    ...
    private void styleButtons() {
        ...
        // Deal button styling
        Button dealButton = blackJack.getDeal();
        ...
        // Hit button styling
        Button hitButton = blackJack.getHit();
        ...
        Button standButton = blackJack.getStand();
