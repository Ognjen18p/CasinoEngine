...
public class MenuPage extends Page {
    ...
    protected void initializeElements() {
        ...
        /// !!! Content !!!
        balanceLabel = new Label("Balance: " + GameManager.getInstance().getCurrentPlayer().getBalance());
        ...
        welcomeLabel = new Label("Welcome to Casino Engine!");
        welcomeLabel.setStyle("-fx-font-size: 28px; -fx-font-weight: bold;");

        errorMessageLabel = new Label("");

        centerPanel.getChildren().addAll(welcomeLabel, gameImagesBox, errorMessageLabel);
